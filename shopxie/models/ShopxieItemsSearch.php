...
class ShopxieItemsSearch extends ShopxieItems
{
    ...
    {
        return [
            [['name', 'category', 'item_number', 'description', 'custom5', 'custom6', 'custom7', 'custom8', 'custom9', 'custom10'], 'safe'],
            [['supplier_id', 'receiving_quantity', 'item_id', 'pic_id', 'allow_alt_description', 'is_serialized', 'deleted', 'brand_id', 'parent_id', 'category_id', 'subcategory_id', 'item_color', 'vendor_id'], 'integer'],
