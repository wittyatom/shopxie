...
/**
 * ShopxieSalesSuspendedItemsSearch represents the model behind the search form about `app\models\ShopxieSalesSuspendedItems`.
 */
class ShopxieSalesSuspendedItemsSearch extends ShopxieSalesSuspendedItems
{
    /**
     * @inheritdoc
     */
