...
/**
 * ShopxieSalesReturnItemsSearch represents the model behind the search form about `app\models\ShopxieSalesReturnItems`.
 */
class ShopxieSalesReturnItemsSearch extends ShopxieSalesReturnItems
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = ShopxieSalesReturnItems::find();
