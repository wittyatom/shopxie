...
/**
 * ShopxieSalesSuspendedSearchItems represents the model behind the search form about `app\models\ShopxieSalesSuspendedItems`.
 */
class ShopxieSalesSuspendedSearchItems extends ShopxieSalesSuspendedItems
{
    /**
     * @inheritdoc
     */
